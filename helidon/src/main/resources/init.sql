CREATE TABLE IF NOT EXISTS fruits (id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, name VARCHAR(255) NOT NULL UNIQUE, description VARCHAR(255));
CREATE TABLE IF NOT EXISTS stores (id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, name VARCHAR(255) NOT NULL UNIQUE, address VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, country VARCHAR(255) NOT NULL, currency VARCHAR(255) NOT NULL);
...
SELECT setval(pg_get_serial_sequence('fruits', 'id'), 11, false);
...
SELECT setval(pg_get_serial_sequence('stores', 'id'), 9, false);
